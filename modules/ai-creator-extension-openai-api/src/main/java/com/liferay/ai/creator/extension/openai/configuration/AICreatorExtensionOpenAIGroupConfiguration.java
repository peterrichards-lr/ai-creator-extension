...
@Meta.OCD(
        id = "com.liferay.ai.creator.extension.openai.configuration.AICreatorExtensionOpenAIGroupConfiguration",
        localization = "content/Language",
        name = "ai-creator-extension-openai-group-configuration-name"
)
public interface AICreatorExtensionOpenAIGroupConfiguration extends AICreatorOpenAIGroupConfiguration {
